...
(function e$jscomp$0(v, n, b) {
  ...
  3: [function (c, v, n) {
    ...
    b.prototype.add = function (b, d, c) {
      d ? (b = new u(b, d), c && b.changeTransform(c), this.addToTree(b)) : a.arr(b) ? ((new u).add(b), this.addToTree(_clip)) : this.addToTree(b);
      return this
    };
    ...
    b.prototype.jumpTo = function (b) {
      (b = a.str(b) ? this.find(b) : b) && this.jump(b.gband[0])
    };
    ...
    b.prototype._register = function (a) {
      if (this.hash[a.id]) throw w.animation(z.A.ELEMENT_IS_REGISTERED, this);
      a.registered = !0;
      a.anim = this;
      this.hash[a.id] = a;
      var b = this;
    ...
    b.prototype.findAll = function (a, b) {
      return A.all(a).over(b ? b.children : this.tree)
    };
  ...
  4: [function (c, v, n) {
    var b = {
      ...
      wrap: function (b, a) {
        return b ? [b[0] + a[0], b[0] + a[1] <= b[1] ? b[0] + a[1] : b[1]] : a
      },
      expand: function (b, a) {
  ...
  6: [function (c, v, n) {
    ...
    a.prototype.initState = function () {
      ...
      this._angle = 0;
      this._alpha = 1;
      this._matrix ? this._matrix.reset() : this._matrix = new w;
    ...
    a.prototype.modifiers = function (h, f, b) {
      b = b || D.ALL_MODIFIERS;
      f = f || 0;
      ...
      for (var d = this.$modifiers, c, B, m, q, z = 0, g = b.length; z < g; z++) {
        ...
        if (B = d[c])
          for (var e = 0, x = B.length; e < x; e++)
            if (m = B[e], q = this.__adaptModTime(m, h), null !== q && (!1 === q || !1 === m.apply(this, q[0], f, q[1]))) return this.__mafter(h, this.__modifying, !1), this.__modifying = null, !1;
        this.__mafter(h, c, !0)
      }
        ...
        if (c !== a.NO_TIME) {
          ...
          if (d) {
            ...
            if (B) {
              ...
              g.save();
              z.save();
              g.setTransform(e, 0, 0, e, -y * e, -p * e);
    ...
    a.prototype.modify = function (h, a) {
      ...
      h && (a.$band = h);
      if (a.__applied_to && a.__applied_to[this.id]) throw m.element("This modifier is already applied to this Element", this);
    ...
    a.prototype.removeModifier = function (a) {
      ...
      if (!a.__applied_to || !a.__applied_to[this.id]) throw m.element(f.A.MODIFIER_NOT_ATTACHED, this);
    ...
    a.prototype.paint = function (a) {
      ...
      if (a.__applied_to && a.__applied_to[this.id]) throw m.element("This painter is already applied to this Element", this);
    ...
    a.prototype.removePainter = function (a) {
      ...
      if (!a.__applied_to || !a.__applied_to[this.id]) throw m.element(f.A.PAINTER_NOT_ATTACHED, this);
    ...
    a.prototype.inform = function (a, f) {
    ...
    a.prototype.m_on = function (a, f) {
      this.modify(new D(function (h) {
        if (this.__evt_st.check(a))
          for (var b = this.evts[a], d = 0, c = b.length; d < c; d++)
    ...
    a.prototype.reverseEach = function (a) {
      var h = this.children;
      this.__unsafeToRemove = !0;
    ...
    a.prototype.extractState = function () {
      return {
        x: this.x,
        y: this.y,
        sx: this.sx,
    ...
    a.prototype.adapt = function (a, f) {
    ...
    a.prototype.inverseAdaptBounds = function (a) {
      var f = this.matrix,
        ...
        b = f.transformPointInverse(a.x + a.width, a.y),
    ...
    a.prototype.applyBrushes = function (a) {
      this.$shadow && this.$shadow.apply(a);
    ...
    a.prototype.ensureHasMaskCanvas = function (a) {
      this.__maskCvs && this.__backCvs || (this.__maskCvs = u.createCanvas(1, 1), this.__maskCtx = u.getContext(this.__maskCvs, "2d"), this.__backCvs = u.createCanvas(1, 1), this.__backCtx = u.getContext(this.__backCvs, "2d"))
    };
    ...
    a.prototype.__adaptModTime = function (f, d) {
      var h = this.lband[1] - this.lband[0],
        ...
        q = f.$relative,
        z = f.is_tween;
      if (this.clip_band && (d = a.checkRepeatMode(d, this.clip_band, this.clip_mode || t.R_ONCE, this.clip_nrep), 0 > d)) return !1;
      if (null === m) m = d;
      else if (k.arr(m)) {
    ...
    a.prototype.__pafter = function (a, f) {};
    a.prototype.__checkJump = function (f) {
      ...
      b = null !== b ? b : f;
      return k.defined(this.__lastJump) ? (k.finite(this.__lastJump[1]) ? this.__lastJump[1] : 0) + (b - this.__lastJump[0]) : null !== b ? b : a.NO_TIME
    };
    ...
    a.prototype._hasRemoteResources = function (a, f) {
      return f.imagesEnabled && this.$image || this.is(t.ET_AUDIO) && f.audioEnabled || this.is(t.ET_VIDEO) && f.videoEnabled ? !0 : this.$mask ? this.$mask._hasRemoteResources(a, f) : !1
    };
    ...
    a.prototype._loadRemoteResources = function (a, f) {
      ...
      this.is(t.ET_VIDEO) && f.videoEnabled && this.$video.load(this.id, f);
  ...
  9: [function (c, v, n) {
    ...
    function d(a, b, c) {
      c = c || 0;
      if (0 === b.length || c >= b.length) return null;
  ...
  10: [function (c, v, n) {
    ...
    u.register(a.T_ROT_TO_PATH, {
      func: function () {
        return function (a) {
          if (a = this.$mpath) this.angle += a.tangentAt(this.$mpath_t || .001)
        }
      },
      from: e,
      to: e
  ...
  12: [function (c, v, n) {
    ...
    c.M_PREVIEW = c.M_CONTROLS_DISABLED | c.M_INFO_DISABLED | c.M_DO_NOT_HANDLE_EVENTS | c.M_DRAW_STILL | c.M_FINITE_DURATION;
          ...
          if (!this.disabled) {
            ...
            if (!this.filterEvent || this.filterEvent.apply(this, arguments))
              if (this["handle_" + a] || this.handlers[a].length) {
                for (var b = Array(arguments.length - 1), c = 1; c < arguments.length; c++) b[c - 1] = arguments[c];
  ...
  17: [function (c, v, n) {
    ...
    b.prototype.apply = function (d) {
      if (this.type != a.BT_NONE) {
        ...
        else if (this.type == a.BT_STROKE) 0 < this.width ? (d.lineWidth = this.width, d.strokeStyle = c || b.DEFAULT_STROKE, d.lineCap = this.cap || b.DEFAULT_CAP, d.lineJoin = this.join || b.DEFAULT_JOIN) : b.clearStroke(d);
    ...
    b.prototype.convertColorsToRgba = function () {
      if (!this._converted) {
    ...
    b.value = function (d, c) {
      ...
      if (d)
        ...
        if (d = d instanceof e ? d.get() : d, p.defined(d.r) && p.defined(d.g) && p.defined(d.b)) g.type = a.BT_FILL, g.color = d;
    ...
    b.interpolateBrushes = function (c, e) {
      ...
      return function (b) {
        ...
        if (c.color) z.grad = null, z.color = t.toRgbaStr(t.interpolate(c.color, e.color, b));
          ...
          k.r ? (g.r || (g.r = []), g.r[0] = d.interpolateFloat(k.r[0], w.r[0], b), g.r[1] = d.interpolateFloat(k.r[1], w.r[1], b)) : g.r = null
        }
        z.invalidate();
        return z
      }
    ...
    e.prototype.get = function () {
      return {
        r: this.$radial ? this.$radius || [1, 1] : null,
        stops: this.$stops,
        bounds: this.$bounds,
        dir: this.$direction
      }
  ...
  18: [function (c, v, n) {
    var b = c("../utils.js"),
      ...
      a = {
        ...
        fromHsl: function (b) {
          return 0 !== b.indexOf("hsl(") ? null : (b = a.HSL_RE.exec(b)) ? a.fromHslVal(parseInt(b[1]) / 180 * Math.PI, parseInt(b[2]) / 100, parseInt(b[3]) / 100) : null
        },
        fromHsla: function (b) {
  ...
  19: [function (c, v, n) {
    function b(b) {
      this.segs = [];
      this.closed = !1;
      a.str(b) ? (this.parse(b), this.updatePath2D(b)) : a.arr(b) && (this.segs = b);
      this.cached_hits = {}
    }
    c("../constants.js");
    var e = c("../utils.js"),
  ...
  20: [function (c, v, n) {
    ...
    b.prototype.crossings = function (a, b, c) {
      return 0
    };
    ...
    a.prototype.draw = function (a) {
      a.bezierCurveTo(this.pts[0], this.pts[1], this.pts[2], this.pts[3], this.pts[4], this.pts[5])
    };
    ...
    a.prototype.findLengthAndT = function (a, b) {
      for (var d = this.pts, c = a[0], e = a[1], g = d[0], p = d[1], w = d[2], z = d[3], A = d[4], r = d[5], d = Math.sqrt(Math.pow(g - c, 2) + Math.pow(p - e, 2)) + Math.sqrt(Math.pow(w - g, 2) + Math.pow(z - p, 2)) + Math.sqrt(Math.pow(A - w, 2) + Math.pow(r - z, 2)) + 1, C = 1 / d, D = 3 * C, n = D * C, x = C * C * C, m = 2 * n, f = 6 * x, h = c - 2 * g + w, B = e - 2 * p + z, A = 3 * (g - w) - c + A, r = 3 * (p - z) - e + r, z = c, w = e, c = (g - c) * D + h * n + x * A, e = (p - e) * D + B * n + x * r, p = h * m + A * f, m = B * m + r * f, B = A * f, f = r * f, A = h = 0; A < d; A++)
    ...
    a.prototype.crossings = function (a, b, c) {
      var d = this.pts;
      return g.curve(b, c, a[0], a[1], d[0], d[1], d[2], d[3], d[4], d[5], 0)
    };
    ...
    var g = {
      curve: function (a, b, c, e, t, q, y, w, z, A, r) {
        ...
        var u = (t + d) / 2,
          ...
          d = (u + m) / 2,
          k = (x + f) / 2;
        return isNaN(d) || isNaN(k) ? 0 : g.curve(a, b, c, e, t, q, u, x, d, k, r + 1) + g.curve(a, b, d, k, m, f, y, w, z, A, r + 1)
      },
  ...
  22: [function (c, v, n) {
    ...
    b.instances = 0;
    b.MISSED_SIDE = 50;
    b.prototype.load = function (b, c, k, y) {
      k = k || this._callback;
    ...
    b.MISSED_BOUNDS = new k(0, 0, b.MISSED_SIDE, b.MISSED_SIDE);
    b.prototype.bounds = function () {
  ...
  23: [function (c, v, n) {
    ...
    b.DEFAULT_BASELINE = e.BL_MIDDLE;
    ...
    b.prototype.apply = function (a, c, e, g) {
      ...
      g && d.clearShadow(a);
      e ? (e.apply(a), q = 0, this.visitLines(function (b) {
    ...
    b.prototype.bounds = function () {
      return this.$bounds ? this.$bounds : this.$bounds = b.bounds(this, this.lines)
    };
    b.prototype.inside = function (a) {
      return !0
    };
    ...
    b.prototype.clone = function () {
      ...
      this.lines && Array.isArray(this.lines) && (a.lines = [].concat(this.lines));
      return a
    };
    b.prototype.invalidate = function () {
      this.$bounds = null
    ...
    var b = c("./errors.js"),
      e = {
        register: function (a, c) {
          if (e[a]) throw b.system("Importer " + a + " is already registered!");
          e[a] = c
        },
        get: function (a) {
    ...
    var b = c("./utils.js"),
      ...
      t = {
        ...
        loadFromUrl: function (c, d, e, p) {
          ...
          var z = function (c) {
              throw g.system(b.strf(a.P.SNAPSHOT_LOADING_FAILED, [c ? c.message || c : "¢ÄPor qu«±?"]));
            },
  ...
  27: [function (c, v, n) {
    ...
    c.P.IMPORTER_CONSTRUCTOR_PASSED = "You've passed importer constructor to snapshot loader, but not an instance! Probably you used anm.importers.get instead of anm.importers.create.";
    ...
    c.A.MODIFIER_REGISTERED = "Modifier was already added to this element";
  ...
  29: [function (c, v, n) {
    (function (b) {
      ...
      function a(a, b) {
        return function (c) {
          b(Error("Failed to load audio file from " + a + " with error code: " + (c && c.currentTarget && c.currentTarget.error) ? c.currentTarget.error.code : "Unknown"))
        }
      }
      c("../conf.js");
      var g = c("../log.js");
      ...
      e.prototype.setVolume = function (a) {
        ...
        else return this.volume = a, this._gain ? this._gain.gain.value = a : this.audio && (this.audio.volume = a), this
      };
      ...
      p.loadOrGet(b, g.url, function (a, b, c) {
        ...
        var p = function (b) {
          ...
          q = function (a) {
            ...
            for (var f = b = 0; b < w.buffered.length; b++) f += 1 / w.duration * (a[b][1] - a[b][0]);
            c(f)
          },
          x = function (a) {
            p(a);
        ...
        a.error(b ? b.message || b : "Unknown error")
      })
    };
    b.prototype.apply = function (a) {
  ...
  31: [function (c, v, n) {
    var b = c("./errors.js"),
      e = {
        register: function (a, c) {
          if (e[a]) throw b.system("Module " + a + " is already registered!");
          e[a] = c
        },
        get: function (a) {
          return e[a]
  ...
  32: [function (c, v, n) {
    ...
    b.prototype.load = function (b, c, d, m) {
      var f = this,
        h = f.state;
      if (h.happens === e.PLAYING || h.happens === e.PAUSED) throw q.player(t.P.COULD_NOT_LOAD_WHILE_PLAYING, f);
      var x, r, k;
      if (b && b.id && f.anim && f.anim.id == b.id) p.info("Animation with ID=" + b.id + " is already loaded in player, skipping the call");
        ...
        if (f.loadingMode != e.LM_ONPLAY || f._playLock) {
          ...
          if (!f.__canvasPrepared) throw q.player(t.P.CANVAS_NOT_PREPARED, f);
          f._reset();
          h.happens = e.LOADING;
          ...
          b ? b instanceof C ? (f._loadTarget = e.LT_ANIMATION, A.loadAnimation(f, b, c)) : g.arr(b) || b instanceof D ? (f._loadTarget = e.LT_ELEMENTS, A.loadElements(f, b, c)) : g.str(b) ? (f._loadTarget = e.LT_URL, f._loadSrc = b, A.loadFromUrl(f, b, r, c)) : (f._loadTarget = e.LT_IMPORT, A.loadFromObj(f, b, r, c)) : (f._loadTarget = e.LT_ANIMATION, f.anim = new C, c(f.anim));
          B && (f.anim.duration = x);
          return f
        }
    ...
    b.prototype.play = function (a, c, d) {
      var f = this;
      f._ensureHasState();
      var h = f.state;
      if (h.happens !== e.PLAYING || !f.infiniteDuration)
        if (f.loadingMode !== e.LM_ONPLAY || f._lastReceivedAnimationId)
          if (f.loadingMode === e.LM_ONREQUEST && h.happens === e.RES_LOADING) f._postpone("play", arguments);
            ...
            h.duration = f.infiniteDuration ? Infinity : m.duration || (m.isEmpty() ? 0 : C.DEFAULT_DURATION);
    ...
    b.prototype._addOpts = function (a) {
      ...
      this.audioEnabled = g.defined(a.audioEnabled) ? a.audioEnabled : this.audioEnabled;
      ...
      this.muteErrors = g.defined(a.muteErrors) ? a.muteErrors : this.muteErrors;
    ...
    b.prototype._checkOpts = function () {
      if (this.canvas) {
        ...
        this.controlsEnabled && !this.controls ? (this._enableControls(), this.infoEnabled ? this._enableInfo() : this._disableInfo()) : !this.controlsEnabled && this.controls && (this._disableInfo(), this._disableControls());
    ...
    b.prototype.forceRedraw = function () {
    ...
    b.prototype.factor = function () {
      if (this.anim) return this.anim.width === this.width && this.anim.height === this.height ? 1 : Math.min(this.width / this.anim.width, this.height / this.anim.height)
    };
      ...
      if (!(f.__thumbLoading || f.__thumb && f.__thumb.src == b)) {
        if (f.ctx) {
          var h = y.PX_RATIO,
            m = f.ctx;
          m.save();
          m.clearRect(0, 0, f.width * h, f.height * h);
          m.restore()
        }
        var g = new x(b);
        f.__thumbLoading = !0;
    ...
    b.prototype._drawStill = function () {
      var a = this.state,
        c = this.anim;
      this.drawStill ? this.__thumb ? this._drawThumbnail() : c && (!this.infiniteDuration && g.finite(c.duration) ? this.drawAt(c.duration * b.PREVIEW_POS) : this.drawAt(a.from)) : this._drawEmpty()
    };
    b.prototype._drawThumbnail = function () {
      ...
      if (c != m || d != e) {
        ...
        m = e[2];
        e = e[3];
        if (m || e) b.fillStyle = this.ribbonsColor || "#000", m && b.fillRect(m[0], m[1], m[2], m[3]), e && b.fillRect(e[0], e[1], e[2], e[3]);
    ...
    b.prototype._drawErrorSplash = function (a) {
    ...
    b.prototype._resize = function (a, b) {
      ...
      if (!f || f[0] !== d[0] || f[1] !== d[1]) return d[0] && d[1] || (d = f), y.setWrapperSize(this.wrapper, d[0], d[1]), y.setCanvasSize(c, d[0], d[1]), this.width = d[0], this.height = d[1], y.updateCanvasOverlays(c), this.ctx && (y.getAnmProps(this.ctx).factor = this.factor()), this.controls && this.controls.handleAreaChange(), this.forceRedraw(), d
    };
    ...
    b.prototype._disableControls = function () {
      this.controls && (this.controls.disable(), this.controls = null)
    };
    ...
    b.prototype.__subscribePlayingEvents = function (a) {
      if (!this.__anim_handlers || !this.__anim_handlers[a.id]) {
        ...
        this.__anim_handlers || (this.__anim_handlers = {});
    ...
    b.prototype.__subscribeDynamicEvents = function (a) {
      ...
      if (a) {
        var b = !1;
        if (this.__boundTo)
          for (var c = 0, f = this.__boundTo, m = f.length; c < m; c++) a.id === f[c][0] && this.canvas === f[c][1] && (b = !0);
        else this.__boundTo = [];
    ...
    b.prototype._ensureHasState = function () {
      if (!this.state) throw q.player(t.P.NO_STATE, this);
    };
    ...
    b.prototype.__onerror_f = function (a) {
      ...
      try {
        this.state && (this.state.happens = e.ERROR), this.__lastError = a, this.fire(e.S_CHANGE_STATE, e.ERROR), this.anim = null
      } catch (B) {
        throw B;
      }
      try {
    ...
    b.prototype._callPostpones = function () {
      if (this._queue && this._queue.length)
        for (var a = this._queue, b, c = 0, d = a.length; c < d; c++) b = a[c], this[b[0]].apply(this, b[1]);
      this._queue = []
    };
    ...
    b.prototype._applyUrlParamsToAnimation = function (a) {
      g.defined(a.t) ? (this.state.happens === e.PLAYING && this.stop(), this.play(a.t / 100)) : g.defined(a.from) ? (this.state.happens === e.PLAYING && this.stop(), this.play(a.from / 100)) : g.defined(a.p) ? (this.state.happens === e.PLAYING && this.stop(), this.play(a.p / 100).pause()) : g.defined(a.at) && (this.state.happens === e.PLAYING && this.stop(), this.play(a.at / 100).pause())
    };
  ...
  34: [function (c, v, n) {
    function b(a, c, k, r, p, q, u) {
      ...
      if (x.happens === d.PLAYING) {
        ...
        x.__prevt = f;
        if (!r || r(f))
          if (0 === x.__rsec && (x.__rsec = m), 1E3 <= m - x.__rsec && (x.afps = x.__redraws, x.__rsec = m, x.__redraws = 0), x.__redraws++, e(f, h, a, k, c.width, c.height, c.zoom, c.ribbonsColor, c.stretchToCanvas, q, u), c.debug && g(a, x.afps, f), !p || p(f)) return y[c.id] += h, 1 <= y[c.id] && (c.fire(d.S_TIME_UPDATE, f), y[c.id] = 0), x.__lastReq = t(function () {
            b(a, c, k, r, p, q, u)
          })
      }
    }
    ...
    c.p_applyAComp = new n(function (a) {
      this.applyAComp(a)
    }, d.PNT_SYSTEM);
    ...
    c.p_drawPivot = new n(function (a, b) {
      if (b = b || this.$pivot) {
        ...
        a.save();
        c && a.translate(b[0] * c.width, b[1] * c.height);
        a.beginPath();
        a.lineWidth = 1;
        a.strokeStyle = d;
        a.moveTo(0, -10);
    ...
    c.p_drawReg = new n(function (a, b) {
      if (b = b || this.$reg) a.save(), a.lineWidth = 1, a.strokeStyle = "#00f", a.fillStyle = "rgba(0,0,255,.3)", a.translate(b[0], b[1]), a.beginPath(), a.moveTo(-4, -4), a.lineTo(4, -4), a.lineTo(4, 4), a.lineTo(-4, 4), a.lineTo(-4, -4), a.closePath(), a.stroke(), a.beginPath(), a.moveTo(0, -10), a.lineTo(0, 0), a.moveTo(3, 0), a.closePath(), a.stroke(), a.restore()
    }, d.PNT_DEBUG);
  ...
  35: [function (c, v, n) {
    ...
    e.prototype.loadOrGet = function (a, c, d, e, g) {
      ...
      b("request to load " + c);
      k._cache[c] ? (b("> already received, trigerring success"), a = k._cache[c], e && e(a), k.trigger(c, a), q && q(c, 1)) : k._errors[c] ? (b("> failed to load before, notifying with error"), g && g(k._errors[c]), q && q(c, -1)) : k._waiting[a] && k._waiting[a] && k._waiting[a][c] ? (b("> someone is already waiting for it, subscribing"), d = a, k._subscriptions[a] && k._onprogress[a] && (d = a + "-" + Math.floor((new Date).getTime() + 1E3 * Math.random()), k._onprogress[d] = k._onprogress[a]), k.subscribe(d, [c], function (a) {
  ...
  36: [function (c, v, n) {
    ...
    b.prototype.render = function (b) {
      ...
      if (!this.invisible && this.bounds && this.state.changed) {
        ...
        if (r === a.PLAYING) p && (q(f, h, u, v, n), f.save(), F = v - d.bottomControls.height, f.fillStyle = d.button.color, f.fillRect(9, F + 3, 3, 9), f.fillRect(15, F + 3, 3, 9), f.restore(), z(f, h, u, v, m, p, n, x), w(f, u, v, k.muted));
  ...
  39: [function (c, v, n) {
    (function (b) {
      ...
      v.exports = {
        fmt_time: function (b) {
          if (!a.finite(b)) return "¡ç";
          var c = Math.abs(b),
            e = Math.floor(c / 3600),
            g = Math.floor((c - 3600 * e) / 60),
        ...
        makeApiUrl: function (a, b, c) {
          ...
          var e = b = !1;
          "string" === typeof c ? (b = -1 !== c.indexOf("animatron-test.com"), e = -1 !== c.indexOf("animatron.com")) : window && window.location && (c = window.location.hostname, b = -1 !== c.indexOf("animatron-test.com"), e = -1 !== c.indexOf("animatron.com"));
          if (b) return a;
          if (e) return d
        },
  ...
  40: [function (c, v, n) {
    (function (b) {
        ...
        f.onreadystatechange = function () {
          if (4 == f.readyState)
            if (200 == f.status) b && b(f);
              ...
              var d = Error("AJAX request for " + a + " returned " + f.status + " instead of 200");
              if (c) c(d, f);
              else throw d;
            }
        };
      ...
      d.injectElementStyles = function (a, b, c) {
        a.classList ? (a.classList.add(b), a.classList.add(c)) : a.className = a.className ? a.className + (b + " " + c) : b + " " + c;
        a = d.getAnmProps(a);
        a.gen_class = b;
        a.inst_class = c
      };
      ...
      d.moveElementTo = function (a, b, c) {
        ...
        (f && f.inst_rule || a).style.left = 0 === b ? "0" : b + "px";
      ...
      d.assignPlayerToWrapper = function (b, c, f) {
        ...
        x.id = g;
        if (m)
          if (m = f.parentNode || a.body) m.replaceChild(b, f), b.appendChild(f);
      ...
      d.extractUserOptions = function (a) {
        ...
        function c(a) {
          if ("undefined" !== typeof a) return null === a ? null : a ? Number.parseFloat(a) / 100 : 0
        }
        var e = d.PX_RATIO,
        ...
        return {
          ...
          shadowsEnabled: b(a.getAttribute("anm-shadows") || a.getAttribute("anm-shadows-enabled")),
          ...
          forceSceneSize: b(a.getAttribute("anm-scene-size") || a.getAttribute("anm-force-scene-size")),
          inParent: void 0,
      ...
      d.setCanvasSize = function (a, b, c, e) {
        e = e || d.PX_RATIO;
        b |= 0;
        c |= 0;
      ...
      d._saveCanvasPos = function (b) {
        var c = a.defaultView && a.defaultView.getComputedStyle,
          f = c ? parseInt(c(b, null).paddingLeft, 10) || 0 : 0,
      ...
      d.addCanvasOverlay = function (b, c, f, h) {
        ...
        (g || a.body).insertBefore(r, c.nextSibling);
        b.ref_canvas = c;
      ...
      d.registerAsInfoElement = function (a, b) {
        d.injectElementStyles(a, d.INFO_CLASS, d.INFO_INSTANCE_CLASS_PREFIX + (b.id || "no-id"))
      };
      ...
      d.unsubscribeAnimationFromEvents = function (a, b) {
        if (a.__anm.handlers && a.__anm.subscribed && a.__anm.subscribed[b.id]) {
      ...
      var A, r;
      "undefined" !== typeof a.hidden ? (A = "hidden", r = "visibilitychange") : "undefined" !== typeof a.mozHidden ? (A = "mozHidden", r = "mozvisibilitychange") : "undefined" !== typeof a.msHidden ? (A = "msHidden", r = "msvisibilitychange") : "undefined" !== typeof a.webkitHidden && (A = "webkitHidden", r = "webkitvisibilitychange");
      ...
      var D = d.isInIframe() ? b : null,
        E = D ? D.document.referrer.split("/", 3).join("/") : "*";
  ...
  43: [function (c, v, n) {
    ...
    b.prototype.invert = function () {
      var b = 1 / (this.m[0] * this.m[3] - this.m[1] * this.m[2]),
        ...
        c = -this.m[2] * b,
        d = this.m[0] * b,
        p = b * (this.m[2] * this.m[5] - this.m[3] * this.m[4]),
...
var AnimatronImporter = function () {
  ...
  r.node = function (a, b, c, d, e) {
    var f = r._type(a),
      m = null;
    1 == f || f == D || 9 == f || 28 == f || 29 == f ? m = r.branch(f, a, b, c, e) : 0 != f && (m = r.leaf(f, a, b, d, e));
  ...
  r.branch = function (b, f, e, g, k) {
    ...
    for (f = h.length; f--;) {
      ...
      if (n && (n = r.node(n, p, g, m, k))) {
        ...
        n.$reg = p[4] || [0, 0];
        if (p[7]) {
          for (var u = 0, w = Infinity, x = 0, y = p[7], z = 0, B = y.length; z < B; z++) {
            var A = r.tween(y[z]);
        ...
        p[5] ? (n.mode = r.mode(p[5][0]), 1 < p[5].length && (n.nrep = p[5][1] || Infinity)) : n.mode = r.mode(null);
  ...
  r.leaf = function (b, c, e, g, k) {
    ...
    8 == b ? e.$image = r.sheet(c) : 4 == b ? e.$text = r.text(c) : 14 == b ? (e.type = a.ET_AUDIO, e.$audio = r.audio(c), e.$audio.connect(e, k)) : 26 == b ? (e.type = a.ET_VIDEO, e.$video = r.video(c), e.$video.connect(e, k)) : 30 == b ? (e.$from = c[1], e.$to = c[2]) : e.$path = r.path(c);
  ...
  r.text = function (a) {
    ...
    return new k(1 < b.length ? b : b[0], a[4], a[5], a[7] & 2 ? "middle" : "bottom", a[7] & 1 ? !0 : !1)
  };
  r.sheet = function (a) {
  ...
  r.shadow = function (a) {
    return a ? u.shadow(a[3], a[2], a[0], a[1]) : null
  };
  r.grad = function (a) {
    var b = a[0],
      d = a[1];
  ...
  v.prototype.readBits = function (a) {
    for (var b = 0;;) {
      ...
      else return c = -c, b |= this.bitBuf >> c, this.bitPos = c, this.bitBuf &= (1 << c) - 1, b
    }
  };
